...
class BaseBuffer(ABC):
    ...
    ) -> Union[ReplayBufferSamples_v1, RolloutBufferSamples]:
        """
        :param batch_inds:
        :param env:
        :return:
...
class ReplayBuffer(BaseBuffer):
    ...
    def __init__(
        ...
        self.discount_factor = np.zeros((self.buffer_size, self.n_envs), dtype=np.float32)
    ...
    def add(
        ...
        self.discount_factor[self.pos] = np.array(discount_factor).copy()
    ...
    def sample(self, batch_size: int, env: Optional[VecNormalize] = None) -> ReplayBufferSamples_v1:
        """
    ...
    def _get_samples(self, batch_inds: np.ndarray, env: Optional[VecNormalize] = None) -> ReplayBufferSamples:
        ...
        data = (
            ...
            self.rewards[batch_inds, env_indices],
            self.discount_factor[batch_inds, env_indices],
        )
        return ReplayBufferSamples_v1(*tuple(map(self.to_torch, data)))
